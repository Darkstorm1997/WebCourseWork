...
namespace NewsNow.Models
{
    public class NewsNowContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public virtual DbSet<NewsNow.Models.Item> Items { get; set; }

        public virtual DbSet<NewsNow.Models.Category> Categories { get; set; }

        public virtual DbSet<NewsNow.Models.Comment> Comments { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Item>().HasData(
                ...
                new Item()
                {
                    ...
                    HomeImageUrl =
                        "https://images.jpost.com/image/upload/f_auto,fl_lossy/t_Item2016_ControlFaceDetect/428957",
                    Location = "תל אביב, ישראל",
                    Content = exampleContent
                },
                new Item()
                {
                    ...
                    HomeImageUrl =
                        "https://images.jpost.com/image/upload/f_auto,fl_lossy/t_Item2016_ControlFaceDetect/429094",
                    Location = "תל אביב, ישראל",
                    Content = exampleContent
                },
                new Item()
                {
                    ...
                    HomeImageUrl =
                        "https://images.jpost.com/image/upload/f_auto,fl_lossy/t_Item2016_ControlFaceDetect/429990",
                    Location = "תל אביב, ישראל",
                    Content = exampleContent
                },
                new Item()
